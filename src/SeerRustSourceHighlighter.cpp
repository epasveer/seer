...
SeerRustSourceHighlighter::SeerRustSourceHighlighter(QTextDocument *parent) : SeerSourceHighlighter(parent) {

    // Set to default formats.
    setHighlighterSettings(SeerHighlighterSettings::populate(""));
}

void SeerRustSourceHighlighter::setHighlighterSettings(const SeerHighlighterSettings &settings) {
